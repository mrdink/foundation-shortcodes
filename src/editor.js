                ...
                // Label
                {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[label style="' + e.data.style + '" type="' + e.data.type + '"]' + e.data.content + '[/label]');
                            }
                        });
                    }
                },
                ...
                // Tooltip
                {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[tooltip tip="' + e.data.tip + '" position="' + e.data.position + '" type="' + e.data.type + '"]' + e.data.content + '[/tooltip]');
                            }
                        });
                    }
                },
                ...
                // Panel
                {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[panel style="' + e.data.style + '" type="' + e.data.type + '"]' + e.data.content + '[/panel]');
                            }
                        });
                    }
                },
                ...
                // Alert
                {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[alert style="' + e.data.style + '" type="' + e.data.type + '"]' + e.data.content + '[/alert]');
                            }
                        });
                    }
                },
